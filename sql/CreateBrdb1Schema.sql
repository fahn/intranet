...
DROP USER 'Badminton'@'localhost';

CREATE USER 'Badminton'@'localhost' IDENTIFIED BY 'Badminton'; 

CREATE DATABASE BRDB;# 1 Datensatz betroffen. 

GRANT ALL PRIVILEGES ON BRDB . * TO 'Badminton'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE, TRIGGER, EXECUTE ON `BRDB`.* TO 'test'@'localhost';
