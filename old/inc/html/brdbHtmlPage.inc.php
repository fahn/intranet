...
?>
	<title>Badminton Ranking - BC Comet</title>
<?php 
	}
	
	protected function htmlBodyHeader() {
?>
	<header>
		<h1>Badminton Ranking - BC Comet</h1>
	</header>
<?php 
	}
	
	protected function htmlBodyFooter() {
?>
	<footer>
		<p>Badminton Ranking - Version 0.9.2 ALPHA</p>
		<a href = "<?php echo self::PAGE_INFO_MANUAL;?>">Manual</a>
		<a href = "<?php echo self::PAGE_INFO_LICENSE;?>">License</a>
		<a href = "<?php echo self::PAGE_INFO_TPL;?>">Third-Party-Licenses</a>
		<a href = "<?php echo self::PAGE_INFO_IMPRESSUM;?>">Impressum</a>
	</footer>
<?php 
	}
	
	protected function htmlBodyNav() {
?>
	<nav>
		<ul>
			<li>
