...
<div class="tab-content">
  <div id="home" class="tab-pane container active">
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-right">
            <a class="btn btn-success" href="/tournament/add">Turnier hinzufügen</a>
      </div>
      {/if}
    </div>
    {include file="tournament/list_table.tpl" data=$tournamentList}
  ...
  <div id="calendar" class="tab-pane container">
      ...
      {include file="tournament/list_calendar.tpl" data=$calendar}
  </div>
  
  <div id="old" class="tab-pane container">
      <h2 class="display-2 mt-5">Alte Turniere</h2>
      {include file="tournament/list_table.tpl" data=$oldTournamentList}
  </div>
</div>
