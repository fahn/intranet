<h1 class="display-2 mb-5">Verein {if $action == 'edit'}Editieren{else}hinzufügen{/if}</h1>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <input class="form-control"  type="text" id="clubName" name="clubName" placeholder="BC Comet Braunschweig" value="{if $variable['name']}{$variable['name']}{/if}" required>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input class="form-control"  type="text" id="clubClubNumber" name="clubClubNumber" placeholder="100000" value="{if $variable['clubNumber']}{$variable['clubNumber']}{/if}" required>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        <label for = "clubAssociation">Verband</label>
        <input class="form-control"  type="text" id="clubAssociation" name="clubAssociation" placeholder="BS-BS" value="{if $variable['association']}{$variable['association']}{/if}" required>
      </div>
    </div>
  </div>
