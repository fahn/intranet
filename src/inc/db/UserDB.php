...
trait UserDB
{
    ...
    public function GetActiveAndReporterOrAdminPlayer(): ?array
    {
        ...
        return $statement->fetchAll();
    }//end GetActiveAndReporterOrAdminPlayer()
