...
require_once BASE_DIR ."/inc/logic/prgTournament.inc.php";
...
class BrdbHtmlTournamentPage extends BrdbHtmlPage
{
     ...
     * @return void
     */
    public function showTournamentsTMPL(): string
    {
        $this->smarty->assign(array(
    ...
    private function updateTournamentTMPL(string $action = "add"):string
    {
        ...
        $this->smarty->assign(array(
            ...
            "vars"              => $action == "add" ? $this->prgElementTournament->getAllPostVariable() : $tournament,
