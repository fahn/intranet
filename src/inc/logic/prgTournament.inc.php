...
require_once BASE_DIR ."/inc/model/user.inc.php";
require_once BASE_DIR ."/inc/model/tournament.mdl.php";
// export
...
class PrgPatternElementTournament extends APrgPatternElement
{
     ...
     * @return boolean
     */
    private function _deletePlayersFromTournamentId(int $tournamentId,int $playerId): bool
    {
        // player data
        ...
        if ($this->brdb->_deletePlayersFromTournamentId($tournamentId, $playerId))
        {
            ...
            switch ($action) {
                case "deletePlayer":
                    if ($this->issetGetVariable("id") && $this->issetGetVariable("tournamentPlayerId")) {
                      $this->_deletePlayersFromTournamentId($this->getGetVariableInt("id"), $this->getGetVariableInt("tournamentPlayerId"));
                    }
                    break;
