...
class PrgPatternElementPlayer extends APrgPatternElement
{
    ...
    private function processPostInsertPlayer(): bool
    {
        ...
        try {
            $player = new \Badtra\Intranet\Model\Player();
            $player->setFirstname($this->getPostVariableString(self::FORM_PLAYER_FIRSTNAME));
            $player->setLastname($this->getPostVariableString(self::FORM_PLAYER_LASTNAME));
            $player->setGender($this->getPostVariableString(self::FORM_PLAYER_GENDER));
            $player->setBday($this->getPostVariableString(self::FORM_PLAYER_BDAY));
            $player->setPlayerNr($this->getPostVariableString(self::FORM_PLAYER_PLAYERNR));
            $player->setClubId($this->getPostVariableInt(self::FORM_PLAYER_CLUBID));
    ...
    private function processPostUpdatePlayer(): bool
    {
        ...
        try {
            $id = $this->getPostVariableInt(self::FORM_PLAYER_PLAYERID);
     ...
     * @return void
     */
    public function find(\Badtra\Intranet\Model\Player $player): bool
    {
        try {
     ...
     * @return boolean
     */
    public function insert(\Badtra\Intranet\Model\Player $player): bool
    {
        try {
    ...
    public function update(\Badtra\Intranet\Model\Player $player): bool
    {
        try {
