...
class PrgPatternElementClub extends APrgPatternElement
{
    ...
    public function processPostInsertClub(): bool
    {
        ...
        try {
            $club = new \Badtra\Intranet\Model\Club();
    ...
    public function find(\Badtra\Intranet\Model\Club $club): bool
    {
        try {
     ...
     * @return void
     */
    public function insert(\Badtra\Intranet\Model\Club $club)
    {
     ...
     * @return boolean
     */
    public function update(\Badtra\Intranet\Model\Club $club): bool
    {
