...
class PrgPatternElementNews extends APrgPatternElement
{
    ...
    public function processPostInsertNews(): bool
    {
        ...
        try {
            $news = new \Badtra\Intranet\Model\News();
            ...
            if ($this->brdb->insertNews($news)){
                throw new \Exception("Cannot insert News");
            }

            $message = sprintf("News \"% s\" wurde eingetragen", $news->getTitle());
