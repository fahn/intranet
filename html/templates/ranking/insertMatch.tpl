    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control js-data-ajax-player" type="text" id="rankingPlayer" name="rankingPlayer"></select>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control js-data-ajax-player" type="text" id="rankingOpponent" name="rankingOpponent"></select>
            </div>
        </div>
    </div>
